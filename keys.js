...
(function() {
  var Key, clear_rect, draw_curved_rect, draw_keys, draw_text, key_event_codes, key_positions, key_sizes, key_texts, keyboard_press_handlers, keyboard_release_handlers,
  ...
  key_event_codes = [[], [48], [45, 189], [61, 187], [55], [56], [57], [115, 83], [52], [53], [54], [49], [50], [51], [120, 88], [97, 65], [122, 90]];
  ...
  draw_keys = function() {
    ...
    keys = (function() {
      ...
      for (i = _i = 0, _len = key_positions.length; _i < _len; i = ++_i) {
        pos = key_positions[i];
        _results.push(new Key(ctx, pos, key_sizes[i], key_texts[i], key_event_codes[i]));
      }
      return _results;
    })();
    _results = [];
  ...
  Key = (function() {
    function Key(ctx, position, size, text, event_code) {
