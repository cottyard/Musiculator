...
(function() {
  var Key, clear_rect, draw_curved_rect, draw_keys, draw_text, get_action_play, get_action_suspend, get_action_transpose, key_action_begin_funcs, key_action_end_funcs, key_event_codes, key_positions, key_sizes, key_texts, keyboard_press_handlers, keyboard_release_handlers, note_offset, play_note, suspend_note, transpose,
  ...
  get_action_play = function(note) {
    return function() {
      return play_note(note);
    };
  };

  get_action_suspend = function(note) {
    return function() {
      return suspend_note(note);
    };
  };

  get_action_transpose = function(scale) {
    return function() {
      return transpose(scale);
    };
  };

  key_action_begin_funcs = [(function() {}), get_action_play(76), get_action_play(77), get_action_play(79), get_action_play(71), get_action_play(72), get_action_play(74), get_action_transpose(12), get_action_play(65), get_action_play(67), get_action_play(69), get_action_play(60), get_action_play(62), get_action_play(64), get_action_transpose(-12), get_action_transpose(1), get_action_transpose(-1)];

  key_action_end_funcs = [(function() {}), get_action_suspend(76), get_action_suspend(77), get_action_suspend(79), get_action_suspend(71), get_action_suspend(72), get_action_suspend(74), get_action_transpose(-12), get_action_suspend(65), get_action_suspend(67), get_action_suspend(69), get_action_suspend(60), get_action_suspend(62), get_action_suspend(64), get_action_transpose(12), get_action_transpose(-1), get_action_transpose(1)];
  ...
  play_note = function(note) {
    return MIDI.noteOn(0, note + note_offset, 127, 0);
  };

  suspend_note = function(note) {
    return MIDI.noteOff(0, note + note_offset, 0);
  };
