...
(function() {
  var canvas, ctx, draw_halfkey, draw_halfkey_pressed, draw_halfkey_released, draw_key, draw_key_pressed, draw_key_released, draw_piano, halfkey_count, halfkey_height, halfkey_offset_x, halfkey_position_y, halfkey_positions_x, halfkey_status, halfkey_width, handle_note_action, key_count, key_height, key_position_y, key_positions_x, key_radius, key_status, key_width, keyboard_end, keyboard_start, keyboard_width, note_to_piano_key, piano, press_halfkey, press_key, press_note, redraw_piano_decorat, release_halfkey, release_key, release_note, select_action, translate, translate_black, translate_white, with_transparent_blue_decorat, x;
  ...
  note_to_piano_key = function(note) {
    ...
    alphabet = (note - 48) % 12;
    type = alphabet in translate_black ? 'black' : 'white';
  ...
  handle_note_action = function(action_type, note) {
  ...
  press_note = function(note) {
    return handle_note_action('press', note);
  };

  release_note = function(note) {
    return handle_note_action('release', note);
  };
