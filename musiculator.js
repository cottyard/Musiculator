...
(function() {
  var Key, key_action_funcs, key_action_pool, key_event_codes, key_positions, key_sizes, key_texts, keys, music_key_down, music_key_up, note_activators_count, note_key_action, note_offset, play_note, suspend_note, transpose, tune_key_action,
  ...
  keys = function() {
    ...
    return window.keyboard.add_press_handler(32, function() {
  ...
  Key = (function() {
    function Key(id, ctx, position, size, text, event_code) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        c = _ref[_i];
        window.keyboard.add_press_handler(c, this.press);
      }
      _ref1 = this.event_code;
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        c = _ref1[_j];
        window.keyboard.add_release_handler(c, this.release);
      }
